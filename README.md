...
フロントエンド開発とデザインの両方に取り組むエンジニアです。  
ポートフォリオサイトや業務系 Web アプリを開発しており、Next.js / React / TypeScript や Svelte / Vite など、要件に合わせて技術を選んでいます。
...
![Cloudflare Pages](https://img.shields.io/badge/Cloudflare_Pages-Deploy-F38020?style=flat-square&logo=cloudflare&logoColor=white)

- **フロント**: JavaScript, TypeScript, React, Next.js, Svelte, Vite, Tailwind CSS, SCSS
- **バック・データ**: Node.js, Supabase (PostgreSQL), Drizzle ORM, IndexedDB
- **ツール**: Git, Docker, ESLint, Prettier, Vitest, Jest, Playwright
